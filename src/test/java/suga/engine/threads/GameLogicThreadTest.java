...
class GameLogicThreadTest {
    ...
    void run_PerformsCloseToRequest (int targetFps, long sampleTime) {
        ...
        GameEngine.getInstance().getLogger().log(String.format("Game Thread Test: Wanted %dfps and got %.2ffps. Error is %.2f %%", targetFps, thread.getFPS(), (100 - ((targetFps * 100.0) / thread.getFPS()))));
